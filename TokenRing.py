...
token = raw_input("Do I start with the token? y/n: ")
if token == "y":
...
def my_form_post():
	...
	thread.start_new_thread(token_sending.send_token, ())
	return 1


def start():
	thread.start_new_thread(token_sending.multicast_receiver.receive, ())
	thread.start_new_thread(token_sending.multicast_sender.send, ())
